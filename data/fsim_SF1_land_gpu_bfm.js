...
let AC1_RadElement = document.getElementById("AC1_Rad");
let AC1_RadNode = document.createTextNode("");
	AC1_RadElement.appendChild(AC1_RadNode);
...
let AC2_RadElement = document.getElementById("AC2_Rad");
let AC2_RadNode = document.createTextNode("");
	AC2_RadElement.appendChild(AC2_RadNode);
...
let AC2_OfYElement = document.getElementById("AC2_OfY");
let AC2_OfYNode = document.createTextNode("");
	AC2_OfYElement.appendChild(AC2_OfYNode);
let AC2_InXElement = document.getElementById("AC2_InX");
let AC2_InXNode = document.createTextNode("");
	AC2_InXElement.appendChild(AC2_InXNode);
