...
let aaf_ = {
		...
		AAASp2: [1,1,1,1],		// Bullet Spacing - time remaining
		// Bullet Colors and Opacity
		AAACol: 0,				// Green-Blue (Vector2)
		AAAOpa: 0.5,			// Opacity
		// Bullets for each gun
		AAAPtr: [[0],[0],[0],[0]],	// Bullet Objects
		AAAMpS: [[0],[0],[0],[0]],	// Bullet Map Speed (V3)
		AAAMpP: [[0],[0],[0],[0]],	// Bullet Map Position (V3)	
		AAATim: [[0],[0],[0],[0]],	// Bullet Time in flight
		// Smoke
		SmkFlg: [0,0,0,0],		// 1 = Start Smoke
		SmkMap: 2,				// Shared Texture Reference Number
		SmkMat: [0,0,0,0],		// Smoke Material
		SmkPtr: [0,0,0,0],		// Smoke Sprite
		SmkRot: [0,165,330,230], // Z-rotation of smoke
		SmkMpP: [0,0,0,0],		// Map Position (Vector3)
		SmkDMx: [12,11],		// Delay between Smoke events (secs)
		SmkDTm: [0,6,3,5],		// Delay Counter
		SmkOpR:	0.005,			// Opacity Reduction per Frame
		// Smoke Sounds
		SndFlg: [1,1,1,1],		// 1 = Start Explosion Sound
		SndSrc: "https://PhilCrowther.github.io/Aviation/sounds/fx/aaa.mp3",
		SndPtr: [0,0,0,0],
		SndVol: 15,				// Volume
		...
		SndDTm: [0,0,0,0],
		// Explosion
		ExpPtr: [0,0,0,0],		// Pointer to Exploding Center
		ExpSiz: [0,0,0,0],		// Expanding Size
		ExpLif: [0,0,0,0],		// Life of Explosion (seconds)
		// Timer (not used)
