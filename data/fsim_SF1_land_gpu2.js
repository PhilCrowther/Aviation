...
//	Either initialized by Main (^m) or Effects (^e)
let aaf_ = {
		ObjNum: 2,
		// Parent (use this instead of link because bullets not attached)
		...
		// Bullet Data
		AAAFlg: [],				// 1 = Gun Firing
		AAASpd: 0,				// Muzzle Velocity - mps (e.g. 850) [^m]
		AAADLT: 0,				// Max Bullet Time in Flight (e.g. 4.0) [^m]
		AAANum: 0,				// Number of Tracers (e.g. 16) [^m]
		AAASpc: 0,				// Bullet Spacing (4*BulDLT/BulNum) (e.g. 1) [^m]
