...
let xsh_ = {
		...
		ObjSrc: [], 			// Source File
		ObjTxt: [],				// Texture Source File (not used)
		ObjAdr: [],				// Object Address
		ObjSiz: [], 			// Scale		 
		RndOrd: [],				// renderOrder (not used)
		ObjRot: [],				// Object Rotation
		MapPos: [],				// Object Map Position (meters) [used by Mesh]
		ObjGrp: [],				// Group
		// Speed
		SpdMPS: [],				// Speed (mtr/sec) (9 ms = 34 kph = 20 mph) [top speed = 21 mph]
		MapSpd: [],				// Object Map Speed (mtr/sec) used by airplane if landed
		// Animations
		ObjDst: [],				// Object distance (meters) used to activate effects
		MixRdr: [],				// Animation Mixer - Radar
		AnmRdr: [],				// Animation
		// CVE Only
		ShpPit: [],				// Ship Pitch
		ShpLok: [],				// Deck Lock
...
//- Auto-Fill Values
	for (let n = 0; n < xsh_.xshNum; n ++) {
		xsh_.ObjSrc[n] = xshObjSrc[xshObjTyp[n]];
		xsh_.ObjTxt[n] = 0;
		xsh_.ObjAdr[n] = 0;
		xsh_.ObjSiz[n] = xshObjSrc[xshObjSiz[n]];
		xsh_.RndOrd[n] = 0;
		xsh_.ObjRot[n] = 0;		// Euler
		xsh_.MapPos[n] = 0;		// Vector3
		xsh_.ObjGrp[n] = 0;		// Object3D
		xsh_.SpdMPS[n] = xshObjSrc[xshSpdMPS[n]];
		xsh_.MapSpd[n] = 0;		// Vector3
		xsh_.ObjDst[n] = 0;
		xsh_.MixRdr[n] = 0;
		xsh_.AnmRdr[n] = 0;
		xsh_.ShpPit[n] = 0;
