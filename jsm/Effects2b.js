...
let globalDensity = uniform(1.0); // Global adjustment slider
...
//	let opacityNode = textureNode.a.mul(life.oneMinus());
	let opacityNode = textureNode.a.mul(globalDensity).mul(life.oneMinus());
		smokeNodeMaterial.opacityNode = opacityNode;
//		smokeNodeMaterial.opacityNode = opacityNode*BMSopa;
	//	Position
...
function moveBomSmk(bms_,bom_,gen_,n) {
	...
	if (!bms_.GroFlg[n]) {
		...
		if (bms_.RemSiz[n] < 0.001) {
			...
			globalDensity = globalDensity-0.01;
		}
	}
	//	Resize
