...
function moveXSHBul(xsg_,air_,AltDif,DLTime,GrvDLT,SndFlg) {
	...
	for (let n = 0; n < xsg_.ObjNum; n ++) {
		...
		// Combined Map Position
//		MapPos.x = xsg_.GunRef[n].position.x + xsg_.GunPos[n].x;
//		MapPos.y = xsg_.GunRef[n].position.y + xsg_.GunPos[n].y;
//		MapPos.z = xsg_.GunRef[n].position.z + xsg_.GunPos[n].z;
