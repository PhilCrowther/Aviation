...
//	this.air_.MapSpd.x = GS * Math.sin(ACHrad);
	...
	this.air_MapSpd = new Spherical(this.air_.SpdMPF,(90-this.air_.AirRot.x)*DegRad,Mod360(this.air_AirRot.y)*DegRad);
	this.air_MapSpd  = new Vector3().setFromSpherical(this.air_MapSpd);
