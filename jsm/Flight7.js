...
update() {
	...
	if (this.dat_.TDrAng == 0 || this.air_.SpdKPH > this.dat_.TDrSpd) { // If Airplane is not a Taildragger or Speed is greater than TDmin
	...
	if (this.air_.GrdFlg) {
		...
		if (this.dat_.TDrAng) { // If Airplane is Taildragger
