...
update() {
	...
	GrvACD = (GrvACP/this.air_.SpdMPF)*this.RadDeg;	// Degrees = (GrvACP/V)*(180/(PI()) = (GrvACP/V)*this.RadDeg
	...
	if (this.air_.GrdFlg) {
		...
		// If Taildragger All Movement Done by ACPAdj since direction of Flight = 0;
		if (this.dat_.TDrAng) { // Taildragger
		...
		// Starting CFLift
//		this.air_.CfLift = this.air_.CfLift+0.1*this.air_.AirRot.x;	// Set startng this.air_.CfLift
