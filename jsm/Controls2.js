...
function initCamera(camera,cam_,air_,key_) {
	cam_.CamLLD.copy(cam_.SrcLLD[cam_.CamSel]);	// Restore Saved Values
	cam_.CamMMR.copy(cam_.SrcMMR[cam_.CamSel]);	// Rotation min, max, spd
	cam_.CamMMD.copy(cam_.SrcMMD[cam_.CamSel]);	// In/Out - min, max, spd
	cam_.CamPar = cam_.SrcPar[cam_.CamSel]		// Load New Parent
