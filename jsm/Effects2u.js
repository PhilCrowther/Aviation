...
//const GlobalArray = uniformArray([0.6,0.8,1.0],'float');
//const GlobalValue = uniform(0.6);
...
//	let opacityNode = textureNode.a.mul(life.oneMinus());
//	let opacityNode = textureNode.a.mul(life.oneMinus()).mul(GlobalArray.element(n));
	let GlobalValue = uniform(.6);
	let opacityNode = textureNode.a.mul(life.oneMinus()).mul(GlobalValue);
	//	Position
...
//			GlobalArray.element(n) = GlobalArray.element(n) - 0.01;
		}
	}
	//	Resize
