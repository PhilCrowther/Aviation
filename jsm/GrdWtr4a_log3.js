...
//= LOG BUFFER =================//==============================================
let vDepth = varyingProperty("float", "vDepth");  //varying
//params contain uniforms and attributes
let vertexShaderParams = {
	projectionMatrix: cameraProjectionMatrix,
	cameraViewMatrix: cameraViewMatrix,
	modelWorldMatrix: modelWorldMatrix,  
	position: attribute("position")   
}
let vertexShader = wgslFn(`
	fn main_vertex(
		...
		varyings.vDepth = outPosition.w;
		return outPosition;
	}
`, [vDepth]); //add the varying

export {GrdMap,vertexShader,vertexShaderParams,vDepth};
