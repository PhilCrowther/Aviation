...
//	this.bigrMapTexture = new StorageTexture(4*wav_.Res,4*wav_.Res);	// 1024x1024
	this.bigrMapTexture = new StorageTexture(wav_.Res,wav_.Res);
...
update() {
	...
	this.renderer.computeAsync(this.biggerComp);
