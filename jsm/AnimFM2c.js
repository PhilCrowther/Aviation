...
function moveMySong(IdlFlg,air_,mys_,myg_) {
	//- My Airplane .............................................................
	// Switch Between Idle and Engine Sounds
	if (IdlFlg && mys_.EngSnd.isPlaying) {
		mys_.EngSnd.stop();
		mys_.IdlSnd.play();
	}
	if (IdlFlg && mys_.IdlSnd.isPlaying) {
		mys_.IdlSnd.stop();
		mys_.EngSnd.play();
	}
	// Idle Sound
...
function playMySong(IdlFlg,mys_,myg_,gen_) {
	if (IdlFlg && !mys_.IdlSnd.isPlaying) mys_.IdlSnd.play();	// Idle
	if (!IdlFlg && !mys_.EngSnd.isPlaying) mys_.EngSnd.play(); // Engine
