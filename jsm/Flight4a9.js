	...
	if (this.air_.GrdFlg) {
		...
		if (this.dat_.TDrAng) { // Taildragger
			...
			// At MinSpd set this.air_.CfLift so that this.air_.ACPAdj = 0.
				...
				if (MaxAng < this.air_.ACPAdj) this.air_.ACPAdj = MaxAng; // Prevent tail from popping up
			}
...
//			this.air_.CfLift = this.air_.CfLift+0.1*this.air_.AirRot.x;	// Set startng this.air_.CfLift
//			this.air_.CfLift = 0.1*this.air_.AirRot.x+this.dat_.AngInc;	// Set startng this.air_.CfLift
			this.air_.CfLift = (this.air_.ACPAdj+this.dat_.AngInc)/10;	// Set startng this.air_.CfLift (ignore AirRot.x)
		}
	}
	// Store XS, YP, ZS
